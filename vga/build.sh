...
echo "Compiling isr_assembly.asm..."
nasm -f elf32 isr_assembly.asm -o build/isr_assembly.o
...
# Link the kernel
echo "Linking kernel..."
ld -m elf_i386 -T linker.ld -o build/kernel.bin build/boot.o build/isr_assembly.o build/kernel.o
